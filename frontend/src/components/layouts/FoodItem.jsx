        ...
        <div className="col-sm-12 col-md-6 col-lg-3 my-3">
            <div className="card p-3 rounded">
                ...
                <div className="card-body d-flex flex-column">
                    ...
                    {/* <button type="button" id="cart_btn" className="btn btn-primary d-inline ml-4" onClick={addToCartHandler}>Add to Cart</button> */}

                    {
                        !showButtons ? (
                            <button type="button" id="cart_btn" className="btn btn-primary d-inline ml-4" disabled={fooditem.stock === 0} onClick={addToCartHandler}>
                                Add to Cart
                            </button>
                        ) : (
                            <div className="stockCounter d-inline ml-4">
